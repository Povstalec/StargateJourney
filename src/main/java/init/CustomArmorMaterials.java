...
public enum CustomArmorMaterials implements IArmorMaterial
{
	...
	jackal("jackal", 25, new int[] {3, 5, 7, 2}, 12, StargateItems.naquadah_ingot, "item.armor.equip_iron", 1.0f),
	horus("horus", 25, new int[] {3, 5, 7, 2}, 12, StargateItems.naquadah_ingot, "item.armor.equip_iron", 1.0f);
