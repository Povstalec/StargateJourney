...
import net.povstalec.sgjourney.misc.SGJourneyJigsawPlacement;
...
public class StargateOutpost extends Structure
{
    ...
    {
        if (!StargateOutpost.extraSpawningChecks(context))
        {
