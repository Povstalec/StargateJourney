...
public class SoundAccess
{
    ...
    private static SoundEvent getChevronEngageSound(AbstractStargateEntity<?> stargate, short chevron)
    {
		...
		if(stargateVariant != null)
			return SoundEvent.createVariableRangeEvent(ClientStargateVariants.getClientStargateVariant(stargateVariant.clientVariant(), stargate).chevronEngagedSounds().getSound(chevron));
    ...
    private static SoundEvent getChevronOpenSound(MilkyWayStargateEntity stargate, short chevron)
    {
		...
		if(stargateVariant != null)
			return SoundEvent.createVariableRangeEvent(ClientStargateVariants.getMilkyWayStargateVariant(stargateVariant.clientVariant()).chevronOpenSounds().getSound(chevron));
    ...
    private static SoundEvent getChevronEncodeSound(MilkyWayStargateEntity stargate, short chevron)
    {
		...
		if(stargateVariant != null)
			return SoundEvent.createVariableRangeEvent(ClientStargateVariants.getMilkyWayStargateVariant(stargateVariant.clientVariant()).chevronEncodeSounds().getSound(chevron));
    ...
    private static SoundEvent getChevronIncomingSound(AbstractStargateEntity<?> stargate, short chevron)
    {
		...
		if(stargateVariant != null)
			return SoundEvent.createVariableRangeEvent(ClientStargateVariants.getClientStargateVariant(stargateVariant.clientVariant(), stargate).chevronIncomingSounds().getSound(chevron));
	...
	public static SoundEvent getDialStartSound(UniverseStargateEntity stargate)
	{
		...
		if(stargateVariant != null)
			return SoundEvent.createVariableRangeEvent(ClientStargateVariants.getUniverseStargateVariant(stargateVariant.clientVariant()).dialStartSound());
    ...
    public static SoundEvent getRotationStartupSound(AbstractStargateEntity<?> stargate)
    {
		...
		if(stargateVariant != null)
			return SoundEvent.createVariableRangeEvent(ClientStargateVariants.getRotatingStargateVariant(stargateVariant.clientVariant(), stargate).rotationSounds().rotationStartupSound());
    ...
    public static SoundEvent getRotationSound(AbstractStargateEntity<?> stargate)
    {
		...
		if(stargateVariant != null)
			return SoundEvent.createVariableRangeEvent(ClientStargateVariants.getRotatingStargateVariant(stargateVariant.clientVariant(), stargate).rotationSounds().rotationSound());
    ...
    public static SoundEvent getRotationStopSound(RotatingStargateEntity<?> stargate)
    {
		...
		if(stargateVariant != null)
			return SoundEvent.createVariableRangeEvent(ClientStargateVariants.getRotatingStargateVariant(stargateVariant.clientVariant(), stargate).rotationSounds().rotationStopSound());
    ...
    private static SoundEvent getFailSound(AbstractStargateEntity<?> stargate, StargateInfo.Feedback stargateFeedback)
    {
		...
		if(stargateVariant != null)
			return SoundEvent.createVariableRangeEvent(ClientStargateVariants.getClientStargateVariant(stargateVariant.clientVariant(), stargate).failSounds().getSound(stargateFeedback));
    ...
    private static SoundEvent getWormholeOpenSound(AbstractStargateEntity<?> stargate, boolean incoming)
    {
		...
		if(stargateVariant != null)
			return SoundEvent.createVariableRangeEvent(ClientStargateVariants.getClientStargateVariant(stargateVariant.clientVariant(), stargate).wormholeSounds().getOpenSound(incoming));
    ...
    public static SoundEvent getWormholeIdleSound(AbstractStargateEntity<?> stargate, boolean incoming)
    {
		...
		if(stargateVariant != null)
			return SoundEvent.createVariableRangeEvent(ClientStargateVariants.getClientStargateVariant(stargateVariant.clientVariant(), stargate).wormholeSounds().getIdleSound(incoming));
    ...
    private static SoundEvent getWormholeCloseSound(AbstractStargateEntity<?> stargate, boolean incoming)
    {
		...
		if(stargateVariant != null)
			return SoundEvent.createVariableRangeEvent(ClientStargateVariants.getClientStargateVariant(stargateVariant.clientVariant(), stargate).wormholeSounds().getCloseSound(incoming));
