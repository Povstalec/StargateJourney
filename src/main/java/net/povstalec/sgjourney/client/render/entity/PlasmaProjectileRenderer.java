...
public class PlasmaProjectileRenderer extends EntityRenderer<PlasmaProjectile>
{
	...
	public void render(PlasmaProjectile projectile, float p_114081_, float partialTick, PoseStack stack, MultiBufferSource source, int light)
	{
		...
		vertex(vertexconsumer, matrix4f, posestack$pose, 0.0F, 0, 0, 1);
		vertex(vertexconsumer, matrix4f, posestack$pose, 1.0F, 0, 1, 1);
		vertex(vertexconsumer, matrix4f, posestack$pose, 1.0F, 1, 1, 0);
		vertex(vertexconsumer, matrix4f, posestack$pose, 0.0F, 1, 0, 0);
	...
	private static void vertex(VertexConsumer consumer, Matrix4f matrix4f, PoseStack.Pose pose, float p_114094_, int p_114095_, int p_114096_, int p_114097_)
	{
