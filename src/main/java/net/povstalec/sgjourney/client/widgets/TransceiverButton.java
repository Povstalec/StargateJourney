...
public class TransceiverButton extends Button
{
	public static final ResourceLocation WIDGETS_LOCATION = new ResourceLocation(StargateJourney.MODID, "textures/gui/transceiver/transceiver_widgets.png");
	
    public TransceiverButton(int x, int y, Component component, OnPress press)
	{
		super(x, y, 16, 10, component, press, Button.NO_TOOLTIP);
	}
    ...
    public void renderButton(PoseStack p_93676_, int p_93677_, int p_93678_, float p_93679_)
    {
        ...
        this.blit(p_93676_, this.x, this.y, 0, i * 10, this.width, this.height);
