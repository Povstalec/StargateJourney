...
public abstract class MilkyWayDHDSymbolButton<M extends IDHDMenu> extends GenericDHDSymbolButton<M>
{
	...
	public MilkyWayDHDSymbolButton(int x, int y, int width, int height, M menu, int screenWidth, int screenHeight,
	...
	public MilkyWayDHDSymbolButton(int leftPos, int topPos, M menu, int screenWidth, int screenHeight, int symbol, int canonSymbol, DefaultButton defaultButton, Button.OnPress onPress)
	{
	...
	public static class Dialing extends MilkyWayDHDSymbolButton<MilkyWayDHDMenu>
	{
		public Dialing(int x, int y, int width, int height, MilkyWayDHDMenu menu, int screenWidth, int screenHeight, float xCenter, float yCenter, int textureX, int textureY, int symbol, int canonSymbol, Position position, OnPress onPress)
		{
		...
		public Dialing(int leftPos, int topPos, MilkyWayDHDMenu menu, int screenWidth, int screenHeight, int symbol, int canonSymbol, DefaultButton defaultButton, OnPress onPress)
		{
	...
	public static class Engraving extends MilkyWayDHDSymbolButton<DHDEngravingMenu.MilkyWay>
	{
		protected final DHDEngravingScreen.MilkyWay screen;
		
		public Engraving(int x, int y, int width, int height, DHDEngravingScreen.MilkyWay screen, int screenWidth, int screenHeight, float xCenter, float yCenter, int textureX, int textureY, int symbol, int canonSymbol, Position position, OnPress onPress)
		{
		...
		public Engraving(int leftPos, int topPos, DHDEngravingScreen.MilkyWay screen, int screenWidth, int screenHeight, int symbol, int canonSymbol, DefaultButton defaultButton, OnPress onPress)
		{
