...
{
	public static final ResourceLocation UNIVERSE_BUTTONS = new ResourceLocation(StargateJourney.MODID, "textures/gui/dhd/universe/universe_dhd_buttons.png");
	public static final ResourceLocation UNIVERSE_BUTTONS_OVERLAY = new ResourceLocation(StargateJourney.MODID, "textures/gui/dhd/universe/universe_dhd_buttons_overlay.png");
