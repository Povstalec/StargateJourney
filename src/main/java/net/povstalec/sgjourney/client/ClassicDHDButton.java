...
@OnlyIn(Dist.CLIENT)
public class ClassicDHDButton extends Button
{
    ...
    public ClassicDHDButton(int x, int y, ClassicDHDScreen dhd, int i)
	{
		super(x, y, 16, 16, symbol("sgjourney:milky_way", i), (n) -> {dhd.engageChevron(i);}, Button.DEFAULT_NARRATION);
	}
