...
public class PegasusDHDScreen extends AbstractDHDScreen
{
	...
	public void init()
	{
		...
		super.init();
		this.addRenderableWidget(new DHDBigButton(x + 72, y + 48, menu, (n) -> {menu.engageChevron(0); this.onClose();}, new ResourceLocation(StargateJourney.MODID, "textures/gui/pegasus_dhd_widgets.png")));
	}
