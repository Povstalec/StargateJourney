...
public class MilkyWayDHDScreen extends AbstractDHDScreen
{
	...
	public void init()
	{
		...
		super.init();
		this.addRenderableWidget(new DHDBigButton(x + 72, y + 48, (n) -> {menu.engageChevron(0);}, new ResourceLocation(StargateJourney.MODID, "textures/gui/milky_way_dhd_widgets.png")));
	}
