...
public class ConfigScreenClientStargate extends Screen
{
    ...
    public void init()
    {
		...
		this.configList.add(new BooleanConfigEntry(Component.translatable("gui.sgjourney.cap_movie_chevron_locking"), this.width, ClientStargateConfig.cap_movie_chevron_locking));
		this.configList.add(new BooleanConfigEntry(Component.translatable("gui.sgjourney.movie_front_chevrons_locking"), this.width, ClientStargateConfig.movie_front_chevrons_locking));
