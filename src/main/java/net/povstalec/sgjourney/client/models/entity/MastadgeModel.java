...
public class MastadgeModel extends AgeableListModel<Mastadge>
{
	...
	public MastadgeModel(ModelPart modelPart)
	{
	...
	@Override
	public void setupAnim(Mastadge p_102785_, float p_102786_, float p_102787_, float p_102788_, float p_102789_, float p_102790_)
	{
