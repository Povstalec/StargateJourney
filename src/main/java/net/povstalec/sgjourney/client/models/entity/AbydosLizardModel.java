...
public class AbydosLizardModel extends HierarchicalModel<AbydosLizard>
{
	...
	public AbydosLizardModel(ModelPart part)
	{
		this.root = part;
	...
	@Override
	public void setupAnim(AbydosLizard abydosLizard, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
