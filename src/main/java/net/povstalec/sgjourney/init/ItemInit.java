...
import net.povstalec.sgjourney.items.crystals.MaterializationCrystalItem;
...
public class ItemInit
{
	...
	//Armor
		...
		public static final RegistryObject<JackalArmorItem> JACKAL_HELMET = ITEMS.register("jackal_helmet", 
				() -> new JackalArmorItem(ArmorMaterialInit.jaffa, EquipmentSlot.HEAD, new Item.Properties()));
		public static final RegistryObject<FalconArmorItem> FALCON_HELMET = ITEMS.register("falcon_helmet", 
				() -> new FalconArmorItem(ArmorMaterialInit.jaffa, EquipmentSlot.HEAD, new Item.Properties()));
