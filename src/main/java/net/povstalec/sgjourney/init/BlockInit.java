...
import net.povstalec.sgjourney.blocks.address.SandstoneCartoucheBlock;
import net.povstalec.sgjourney.blocks.address.SandstoneSymbolBlock;
import net.povstalec.sgjourney.blocks.address.StoneCartoucheBlock;
import net.povstalec.sgjourney.blocks.address.StoneSymbolBlock;
import net.povstalec.sgjourney.blocks.stargate.MilkyWayStargateBlock;
import net.povstalec.sgjourney.blocks.stargate.MilkyWayStargateRingBlock;
import net.povstalec.sgjourney.blocks.stargate.PegasusStargateBlock;
import net.povstalec.sgjourney.blocks.stargate.PegasusStargateRingBlock;
...
public class BlockInit
{
	...
	public static final RegistryObject<MilkyWayStargateRingBlock> MILKY_WAY_RING = registerLonelyBlock("milky_way_ring", 
	...
	public static final RegistryObject<PegasusStargateBlock> PEGASUS_STARGATE = registerEntityBlock("pegasus_stargate", 
			() -> new PegasusStargateBlock(BlockBehaviour.Properties.of(Material.METAL).strength(6.0F, 1200.0F)
					.sound(SoundType.METAL).noOcclusion()), Rarity.EPIC);
	public static final RegistryObject<PegasusStargateRingBlock> PEGASUS_RING = registerLonelyBlock("pegasus_ring", 
	...
	public static final RegistryObject<StoneCartoucheBlock> STONE_CARTOUCHE = registerBlock("stone_cartouche", 
			() -> new StoneCartoucheBlock(BlockBehaviour.Properties.of(Material.STONE).strength(0.8F).requiresCorrectToolForDrops()), 1);
	...
	public static final RegistryObject<SandstoneSymbolBlock> SANDSTONE_SYMBOL = registerBlock("sandstone_symbol", 
			() -> new SandstoneSymbolBlock(BlockBehaviour.Properties.of(Material.STONE).strength(0.8F).requiresCorrectToolForDrops().noOcclusion()));
	...
	private static <T extends Block>RegistryObject<T> registerLonelyBlock(String name, Supplier<T> block)
	{
		RegistryObject<T> toReturn = BLOCKS.register(name, block);
