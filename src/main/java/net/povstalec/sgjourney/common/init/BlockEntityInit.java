...
public class BlockEntityInit
{
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<AncientTransportRingsEntity>> ANCIENT_TRANSPORT_RINGS = BLOCK_ENTITIES.register("ancient_transport_rings",
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<NaquadahGeneratorEntity.Reactor>> NAQUADAH_REACTOR = BLOCK_ENTITIES.register("naquadah_reactor",
			() -> BlockEntityType.Builder.of(NaquadahGeneratorEntity.Reactor::new, BlockInit.NAQUADAH_REACTOR.get()).build(null));
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<NaquadahGeneratorEntity.MarkI>> NAQUADAH_GENERATOR_MARK_I = BLOCK_ENTITIES.register("naquadah_generator_mark_i",
            () -> BlockEntityType.Builder.of(NaquadahGeneratorEntity.MarkI::new, BlockInit.NAQUADAH_GENERATOR_MARK_I.get()).build(null));
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<NaquadahGeneratorEntity.MarkII>> NAQUADAH_GENERATOR_MARK_II = BLOCK_ENTITIES.register("naquadah_generator_mark_ii",
