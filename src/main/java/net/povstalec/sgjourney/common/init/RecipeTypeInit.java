...
public class RecipeTypeInit
{
	...
	public static final RegistryObject<RecipeSerializer<NBTRetainingShapedRecipe>> NBT_RETAINING_SHAPED_RECIPE = SERIALIZERS.register("nbt_retaining_shaped_recipe", () -> NBTRetainingShapedRecipe.Serializer.INSTANCE);
