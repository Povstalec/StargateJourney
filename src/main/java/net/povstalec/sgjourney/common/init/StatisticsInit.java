...
public class StatisticsInit
{
	...
	public static final DeferredHolder<ResourceLocation, ResourceLocation> TIMES_USED_TRANSPORTER = STATISTICS.register("times_used_transporter", () -> registerDefaultStatistic("times_used_transporter"));
	public static final DeferredHolder<ResourceLocation, ResourceLocation> DISTANCE_TRAVELED_BY_TRANSPORTER = STATISTICS.register("distance_traveled_by_transporter", () -> registerDistanceStatistic("distance_traveled_by_transporter"));
