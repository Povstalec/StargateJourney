...
public class ItemInit
{
	...
	public static final RegistryObject<ArmorItem> SYSTEM_LORD_HELMET = ITEMS.register("system_lord_helmet",
			() -> new ArmorItem(ArmorMaterialInit.SYSTEM_LORD, EquipmentSlot.HEAD, new Item.Properties().fireResistant().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> SYSTEM_LORD_CHESTPLATE = ITEMS.register("system_lord_chestplate",
			() -> new ArmorItem(ArmorMaterialInit.SYSTEM_LORD, EquipmentSlot.CHEST, new Item.Properties().fireResistant().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> SYSTEM_LORD_LEGGINGS = ITEMS.register("system_lord_leggings",
			() -> new ArmorItem(ArmorMaterialInit.SYSTEM_LORD, EquipmentSlot.LEGS, new Item.Properties().fireResistant().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> SYSTEM_LORD_BOOTS = ITEMS.register("system_lord_boots",
			() -> new ArmorItem(ArmorMaterialInit.SYSTEM_LORD, EquipmentSlot.FEET, new Item.Properties().fireResistant().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	...
	public static final RegistryObject<StargateIrisItem.Copper> COPPER_IRIS = ITEMS.register("copper_iris", 
			() -> new StargateIrisItem.Copper(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_STUFF)));
	public static final RegistryObject<StargateIrisItem.Iron> IRON_IRIS = ITEMS.register("iron_iris", 
			() -> new StargateIrisItem.Iron(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_STUFF)));
	public static final RegistryObject<StargateIrisItem.Gold> GOLDEN_IRIS = ITEMS.register("golden_iris", 
			() -> new StargateIrisItem.Gold(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_STUFF)));
	public static final RegistryObject<StargateIrisItem.Diamond> DIAMOND_IRIS = ITEMS.register("diamond_iris", 
			() -> new StargateIrisItem.Diamond(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_STUFF)));
	public static final RegistryObject<StargateIrisItem.Netherite> NETHERITE_IRIS = ITEMS.register("netherite_iris", 
			() -> new StargateIrisItem.Netherite(new Item.Properties().stacksTo(1).fireResistant().tab(TabInit.STARGATE_STUFF)));

	public static final RegistryObject<StargateIrisItem.NaquadahAlloy> NAQUADAH_ALLOY_IRIS = ITEMS.register("naquadah_alloy_iris", 
			() -> new StargateIrisItem.NaquadahAlloy(new Item.Properties().stacksTo(1).fireResistant().tab(TabInit.STARGATE_STUFF)));
