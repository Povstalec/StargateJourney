...
public class ItemInit
{
	...
	//Armor
		public static final RegistryObject<ArmorItem> NAQUADAH_HELMET = ITEMS.register("naquadah_helmet", 
				() -> new ArmorItem(ArmorMaterialInit.naquadah, EquipmentSlot.HEAD, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		public static final RegistryObject<ArmorItem> NAQUADAH_CHESTPLATE = ITEMS.register("naquadah_chestplate", 
				() -> new ArmorItem(ArmorMaterialInit.naquadah, EquipmentSlot.CHEST, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		public static final RegistryObject<ArmorItem> NAQUADAH_LEGGINGS = ITEMS.register("naquadah_leggings", 
				() -> new ArmorItem(ArmorMaterialInit.naquadah, EquipmentSlot.LEGS, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		public static final RegistryObject<ArmorItem> NAQUADAH_BOOTS = ITEMS.register("naquadah_boots", 
				() -> new ArmorItem(ArmorMaterialInit.naquadah, EquipmentSlot.FEET, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		
		public static final RegistryObject<ArmorItem> JAFFA_HELMET = ITEMS.register("jaffa_helmet", 
				() -> new ArmorItem(ArmorMaterialInit.jaffa, EquipmentSlot.HEAD, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		public static final RegistryObject<ArmorItem> JAFFA_CHESTPLATE = ITEMS.register("jaffa_chestplate", 
				() -> new ArmorItem(ArmorMaterialInit.jaffa, EquipmentSlot.CHEST, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		public static final RegistryObject<ArmorItem> JAFFA_LEGGINGS = ITEMS.register("jaffa_leggings", 
				() -> new ArmorItem(ArmorMaterialInit.jaffa, EquipmentSlot.LEGS, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		public static final RegistryObject<ArmorItem> JAFFA_BOOTS = ITEMS.register("jaffa_boots", 
				() -> new ArmorItem(ArmorMaterialInit.jaffa, EquipmentSlot.FEET, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		
		public static final RegistryObject<JackalArmorItem> JACKAL_HELMET = ITEMS.register("jackal_helmet", 
				() -> new JackalArmorItem(ArmorMaterialInit.jaffa, EquipmentSlot.HEAD, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		public static final RegistryObject<FalconArmorItem> FALCON_HELMET = ITEMS.register("falcon_helmet", 
				() -> new FalconArmorItem(ArmorMaterialInit.jaffa, EquipmentSlot.HEAD, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
	
	//Tools
		public static final RegistryObject<SGJourneySwordItem> NAQUADAH_SWORD = ITEMS.register("naquadah_sword", 
				() -> new SGJourneySwordItem(ToolMaterialInit.naquadah, 4, -2.4f, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		public static final RegistryObject<SGJourneyPickaxeItem> NAQUADAH_PICKAXE = ITEMS.register("naquadah_pickaxe", 
				() -> new SGJourneyPickaxeItem(ToolMaterialInit.naquadah, 2, -2.8f, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		public static final RegistryObject<SGJourneyAxeItem> NAQUADAH_AXE = ITEMS.register("naquadah_axe", 
				() -> new SGJourneyAxeItem(ToolMaterialInit.naquadah, 6.0f, -3.0f, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		public static final RegistryObject<SGJourneyShovelItem> NAQUADAH_SHOVEL = ITEMS.register("naquadah_shovel", 
				() -> new SGJourneyShovelItem(ToolMaterialInit.naquadah, 2.5f, -3.0f, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
		public static final RegistryObject<SGJourneyHoeItem> NAQUADAH_HOE = ITEMS.register("naquadah_hoe", 
				() -> new SGJourneyHoeItem(ToolMaterialInit.naquadah, -2, 0.0f, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));

		public static final RegistryObject<Item> RING_REMOTE = ITEMS.register("ring_remote", 
				() -> new RingRemoteItem(new RingRemoteItem.Properties().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
		...
		public static final RegistryObject<Item> PDA = ITEMS.register("pda", 
				() -> new PDAItem(new PDAItem.Properties().stacksTo(1).rarity(Rarity.RARE).tab(TabInit.STARGATE_ITEMS)));
