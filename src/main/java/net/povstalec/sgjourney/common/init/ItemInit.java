...
public class ItemInit
{
	...
	public static final RegistryObject<Item> PURE_NAQUADAH = ITEMS.register("pure_naquadah", 
			() -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON).stacksTo(16).fireResistant().tab(TabInit.STARGATE_ITEMS)));
	...
	public static final RegistryObject<Item> ANCIENT_TRANSPORT_RING = ITEMS.register("ancient_transport_ring",
			() -> new Item(new Item.Properties().rarity(Rarity.RARE).fireResistant().tab(TabInit.STARGATE_ITEMS)));
	...
	public static final RegistryObject<Item> ADVANCED_CRYSTAL_BASE = ITEMS.register("advanced_crystal_base", 
			() -> new Item(new Item.Properties().rarity(Rarity.RARE).stacksTo(16).tab(TabInit.STARGATE_ITEMS)));
	...
	public static final RegistryObject<Item> HEAVY_LIQUID_NAQUADAH_BUCKET = ITEMS.register("heavy_liquid_naquadah_bucket", 
			() -> new BucketItem(FluidInit.HEAVY_LIQUID_NAQUADAH_SOURCE, new Item.Properties().stacksTo(1).craftRemainder(Items.BUCKET).tab(TabInit.STARGATE_ITEMS)));
	...
	public static final RegistryObject<Item> GOAULD_RING_REMOTE = ITEMS.register("goauld_ring_remote",
			() -> new RingRemoteItem(new RingRemoteItem.Properties().stacksTo(1).rarity(Rarity.UNCOMMON).tab(TabInit.STARGATE_ITEMS)));
	...
	public static final RegistryObject<Item> PDA = ITEMS.register("pda", 
			() -> new PDAItem(new PDAItem.Properties().stacksTo(1).rarity(Rarity.RARE).fireResistant().tab(TabInit.STARGATE_ITEMS)));
	...
	public static final RegistryObject<Item> FUSION_CORE = ITEMS.register("fusion_core",
			() -> new FusionCoreItem(new FusionCoreItem.Properties().stacksTo(1).rarity(Rarity.EPIC).tab(TabInit.STARGATE_STUFF)));
	...
	public static final RegistryObject<SwordItem> TRINIUM_SWORD = ITEMS.register("trinium_sword",
			() -> new SwordItem(ToolMaterialInit.TRINIUM, 4, -2.4f, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<PickaxeItem> TRINIUM_PICKAXE = ITEMS.register("trinium_pickaxe",
			() -> new PickaxeItem(ToolMaterialInit.TRINIUM, 2, -2.8f, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<AxeItem> TRINIUM_AXE = ITEMS.register("trinium_axe",
			() -> new AxeItem(ToolMaterialInit.TRINIUM, 6.0f, -3.0f, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ShovelItem> TRINIUM_SHOVEL = ITEMS.register("trinium_shovel",
			() -> new ShovelItem(ToolMaterialInit.TRINIUM, 2.5f, -3.0f, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<HoeItem> TRINIUM_HOE = ITEMS.register("trinium_hoe",
			() -> new HoeItem(ToolMaterialInit.TRINIUM, -2, 0.0f, new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
	
	public static final RegistryObject<Item> TRINIUM_ARROW = ITEMS.register("trinium_arrow",
			() -> new TriniumArrowItem(new Item.Properties().tab(TabInit.STARGATE_ITEMS)));
	
	// Armor
	public static final RegistryObject<ArmorItem> NAQUADAH_HELMET = ITEMS.register("naquadah_helmet",
			() -> new ArmorItem(ArmorMaterialInit.NAQUADAH, EquipmentSlot.HEAD, new Item.Properties().fireResistant().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> NAQUADAH_CHESTPLATE = ITEMS.register("naquadah_chestplate", 
			() -> new ArmorItem(ArmorMaterialInit.NAQUADAH, EquipmentSlot.CHEST, new Item.Properties().fireResistant().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> NAQUADAH_LEGGINGS = ITEMS.register("naquadah_leggings", 
			() -> new ArmorItem(ArmorMaterialInit.NAQUADAH, EquipmentSlot.LEGS, new Item.Properties().fireResistant().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> NAQUADAH_BOOTS = ITEMS.register("naquadah_boots", 
			() -> new ArmorItem(ArmorMaterialInit.NAQUADAH, EquipmentSlot.FEET, new Item.Properties().fireResistant().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	
	public static final RegistryObject<ArmorItem> TRINIUM_HELMET = ITEMS.register("trinium_helmet",
			() -> new ArmorItem(ArmorMaterialInit.TRINIUM, EquipmentSlot.HEAD, new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> TRINIUM_CHESTPLATE = ITEMS.register("trinium_chestplate",
			() -> new ArmorItem(ArmorMaterialInit.TRINIUM, EquipmentSlot.CHEST, new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> TRINIUM_LEGGINGS = ITEMS.register("trinium_leggings",
			() -> new ArmorItem(ArmorMaterialInit.TRINIUM, EquipmentSlot.LEGS, new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> TRINIUM_BOOTS = ITEMS.register("trinium_boots",
			() -> new ArmorItem(ArmorMaterialInit.TRINIUM, EquipmentSlot.FEET, new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	
	public static final RegistryObject<ArmorItem> JAFFA_HELMET = ITEMS.register("jaffa_helmet", 
			() -> new ArmorItem(ArmorMaterialInit.JAFFA, EquipmentSlot.HEAD, new Item.Properties().fireResistant().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> JAFFA_CHESTPLATE = ITEMS.register("jaffa_chestplate", 
			() -> new ArmorItem(ArmorMaterialInit.JAFFA, EquipmentSlot.CHEST, new Item.Properties().fireResistant().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> JAFFA_LEGGINGS = ITEMS.register("jaffa_leggings", 
			() -> new ArmorItem(ArmorMaterialInit.JAFFA, EquipmentSlot.LEGS, new Item.Properties().fireResistant().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> JAFFA_BOOTS = ITEMS.register("jaffa_boots", 
			() -> new ArmorItem(ArmorMaterialInit.JAFFA, EquipmentSlot.FEET, new Item.Properties().fireResistant().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	
	public static final RegistryObject<JackalArmorItem> JACKAL_HELMET = ITEMS.register("jackal_helmet", 
			() -> new JackalArmorItem(ArmorMaterialInit.JAFFA, EquipmentSlot.HEAD, new Item.Properties().fireResistant().tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<FalconArmorItem> FALCON_HELMET = ITEMS.register("falcon_helmet", 
			() -> new FalconArmorItem(ArmorMaterialInit.JAFFA, EquipmentSlot.HEAD, new Item.Properties().fireResistant().tab(TabInit.STARGATE_ITEMS)));
	
	public static final RegistryObject<ArmorItem> SYSTEM_LORD_HELMET = ITEMS.register("system_lord_helmet",
			() -> new ArmorItem(ArmorMaterialInit.SYSTEM_LORD, EquipmentSlot.HEAD, new Item.Properties().stacksTo(1).fireResistant().tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> SYSTEM_LORD_CHESTPLATE = ITEMS.register("system_lord_chestplate",
			() -> new ArmorItem(ArmorMaterialInit.SYSTEM_LORD, EquipmentSlot.CHEST, new Item.Properties().stacksTo(1).fireResistant().tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> SYSTEM_LORD_LEGGINGS = ITEMS.register("system_lord_leggings",
			() -> new ArmorItem(ArmorMaterialInit.SYSTEM_LORD, EquipmentSlot.LEGS, new Item.Properties().stacksTo(1).fireResistant().tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<ArmorItem> SYSTEM_LORD_BOOTS = ITEMS.register("system_lord_boots",
			() -> new ArmorItem(ArmorMaterialInit.SYSTEM_LORD, EquipmentSlot.FEET, new Item.Properties().stacksTo(1).fireResistant().tab(TabInit.STARGATE_ITEMS)));
	...
	public static final RegistryObject<CrystalComputerItem> POCKET_CRYSTAL_COMPUTER = ITEMS.register("pocket_crystal_computer",
			() -> new CrystalComputerItem(new Item.Properties().rarity(Rarity.UNCOMMON).stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	...
	public static final RegistryObject<Item> STARGATE_SHIELDING_RING = ITEMS.register("stargate_shielding_ring", 
			() -> new Item(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_STUFF)));
	
	// Irises
	public static final RegistryObject<StargateIrisItem> COPPER_IRIS = ITEMS.register("copper_iris",
			() -> new StargateIrisItem(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_STUFF), StargateIrisItem.COPPER_IRIS, () -> CommonIrisConfig.copper_iris_durability.get()));
	public static final RegistryObject<StargateIrisItem> IRON_IRIS = ITEMS.register("iron_iris",
			() -> new StargateIrisItem(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_STUFF), StargateIrisItem.IRON_IRIS, () -> CommonIrisConfig.iron_iris_durability.get()));
	public static final RegistryObject<StargateIrisItem> GOLDEN_IRIS = ITEMS.register("golden_iris",
			() -> new StargateIrisItem(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_STUFF), StargateIrisItem.GOLD_IRIS, () -> CommonIrisConfig.gold_iris_durability.get()));
	public static final RegistryObject<StargateIrisItem> DIAMOND_IRIS = ITEMS.register("diamond_iris",
			() -> new StargateIrisItem(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_STUFF), StargateIrisItem.DIAMOND_IRIS, () -> CommonIrisConfig.diamond_iris_durability.get()));
	public static final RegistryObject<StargateIrisItem> NETHERITE_IRIS = ITEMS.register("netherite_iris",
			() -> new StargateIrisItem(new Item.Properties().stacksTo(1).fireResistant().tab(TabInit.STARGATE_STUFF), StargateIrisItem.NETHERITE_IRIS, () -> CommonIrisConfig.netherite_iris_durability.get()));
	
	public static final RegistryObject<StargateIrisItem> NAQUADAH_IRIS = ITEMS.register("naquadah_iris",
			() -> new StargateIrisItem(new Item.Properties().stacksTo(1).fireResistant().tab(TabInit.STARGATE_STUFF), StargateIrisItem.NAQUADAH_IRIS, () -> CommonIrisConfig.naquadah_iris_durability.get()));
	public static final RegistryObject<StargateIrisItem> NAQUADAH_COPPER_IRIS = ITEMS.register("naquadah_copper_iris",
			() -> new StargateIrisItem(new Item.Properties().stacksTo(1).fireResistant().tab(TabInit.STARGATE_STUFF), StargateIrisItem.NAQUADAH_COPPER_ALLOY_IRIS, () -> CommonIrisConfig.naquadah_copper_alloy_iris_durability.get()));
	public static final RegistryObject<StargateIrisItem> NAQUADAH_IRON_IRIS = ITEMS.register("naquadah_iron_iris",
			() -> new StargateIrisItem(new Item.Properties().stacksTo(1).fireResistant().tab(TabInit.STARGATE_STUFF), StargateIrisItem.NAQUADAH_IRON_ALLOY_IRIS, () -> CommonIrisConfig.naquadah_iron_alloy_iris_durability.get()));
	public static final RegistryObject<StargateIrisItem> TRINIUM_IRIS = ITEMS.register("trinium_iris",
			() -> new StargateIrisItem(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_STUFF), StargateIrisItem.TRINIUM_IRIS, () -> CommonIrisConfig.trinium_iris_durability.get()));

	public static final RegistryObject<StargateIrisItem> BRONZE_IRIS = ITEMS.register("bronze_iris",
			() -> new StargateIrisItem(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_STUFF), StargateIrisItem.BRONZE_IRIS, () -> CommonIrisConfig.bronze_iris_durability.get()));
	public static final RegistryObject<StargateIrisItem> STEEL_IRIS = ITEMS.register("steel_iris",
			() -> new StargateIrisItem(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_STUFF), StargateIrisItem.STEEL_IRIS, () -> CommonIrisConfig.steel_iris_durability.get()));
	...
	public static final RegistryObject<GoauldItem> GOAULD = ITEMS.register("goauld",
			() -> new GoauldItem(new Item.Properties().stacksTo(1).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<Item> GOAULD_CARCASS = ITEMS.register("goauld_carcass",
			() -> new Item(new Item.Properties().food(FoodInit.RAW_GOAULD).tab(TabInit.STARGATE_ITEMS)));
	public static final RegistryObject<Item> COOKED_GOAULD = ITEMS.register("cooked_goauld",
			() -> new Item(new Item.Properties().food(FoodInit.COOKED_GOAULD).tab(TabInit.STARGATE_ITEMS)));
