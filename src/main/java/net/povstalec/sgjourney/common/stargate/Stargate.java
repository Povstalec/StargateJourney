...
public class Stargate
{
	...
	public enum Feedback
	{
		...
		EXCEEDED_CONNECTION_TIME(-18, FeedbackType.ERROR, "exceeded_connection_time"),
		RAN_OUT_OF_POWER(-19, FeedbackType.ERROR, "ran_out_of_power"),
		CONNECTION_REROUTED(-20, FeedbackType.ERROR, "connection_rerouted"),
		WRONG_DISCONNECT_SIDE(-21, FeedbackType.ERROR, "wrong_disconnect_side"),
		CONNECTION_FORMING(-22, FeedbackType.ERROR, "connection_forming"),

		STARGATE_DESTROYED(-23, FeedbackType.ERROR, "stargate_destroyed"),
		COULD_NOT_REACH_TARGET_STARGATE(-24, FeedbackType.MAJOR_ERROR, "could_not_reach_target_stargate"),
		INTERRUPTED_BY_INCOMING_CONNECTION(-25, FeedbackType.ERROR, "interrupted_by_incoming_connection"),
		...
		ROTATION_BLOCKED(-26, FeedbackType.INFO, "rotation_blocked"),
		NOT_ROTATING(-27, FeedbackType.INFO, "not_rotating"),
		ROTATION_STOPPED(13, FeedbackType.INFO, "rotation_stopped"),
		CHEVRON_ALREADY_RAISED(-28, FeedbackType.ERROR, "chevron_already_opened"),
		CHEVRON_ALREADY_LOWERED(-29, FeedbackType.ERROR, "chevron_already_closed"),
		CHEVRON_NOT_RAISED(-30, FeedbackType.ERROR, "chevron_not_raised"),
		CANNOT_ENCODE_POINT_OF_ORIGIN(-31, FeedbackType.ERROR, "cannot_encode_point_of_origin");
