...
public class AdvancedCrystallizerRecipe implements Recipe<CrystalRecipeInput>
{
	...
	public AdvancedCrystallizerRecipe(ItemStack output, Pair<Ingredient, Integer> ingredient1, Pair<Ingredient, Integer> ingredient2, Pair<Ingredient, Integer> ingredient3, boolean depletePrimary, boolean depleteSecondary)
	{
	...
	{
		public static final RecipeType<AdvancedCrystallizerRecipe> ADVANCED_CRYSTALLIZING = register("advanced_crystallizing");
	...
	public static class Serializer implements RecipeSerializer<AdvancedCrystallizerRecipe>
	{
		...
		private static AdvancedCrystallizerRecipe fromNetwork(RegistryFriendlyByteBuf friendlyByteBuf)
		{
			...
			return new AdvancedCrystallizerRecipe(output, Pair.of(ingredient1, amount1), Pair.of(ingredient2, amount2), Pair.of(ingredient3, amount3), depletePrimary, depleteSecondary);
		}
