...
public class UniverseSpawnerStargate extends SGJourneySpawnerStargate implements SpawnerStargate
{
	...
	public UniverseSpawnerStargate(StargateType<?> type, MinecraftServer server)
	{
		super(type, server);
	}
