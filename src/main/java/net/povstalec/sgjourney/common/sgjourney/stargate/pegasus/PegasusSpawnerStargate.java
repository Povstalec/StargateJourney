...
public class PegasusSpawnerStargate extends SGJourneySpawnerStargate implements SpawnerStargate
{
	public static final StargateInfo.ChevronLockSpeed CHEVRON_LOCK_SPEED = CommonStargateConfig.pegasus_chevron_lock_speed.get();
	
	public PegasusSpawnerStargate(StargateType<?> type, MinecraftServer server)
	{
		super(type, server);
	}
