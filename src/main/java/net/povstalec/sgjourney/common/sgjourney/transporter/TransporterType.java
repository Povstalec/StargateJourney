...
public class TransporterType<T extends Transporter>
{
	...
	public static final ResourceLocation TRANSPORTER_TYPE_LOCATION = StargateJourney.sgjourneyLocation(TRANSPORTER_TYPE);
	...
	{
		return TransporterInit.TRANSPORTER_TYPE_REGISTRY.getKey(type);
	}
	
	public static TransporterType<?> getType(ResourceLocation key)
	{
		return TransporterInit.TRANSPORTER_TYPE_REGISTRY.get(key);
	}
