...
public class LiquidNaquadahReactorCoreItem extends Item implements IEnergyCore
{
	public static final String REACTION_PROGRESS = "reaction_progress";
	
	public LiquidNaquadahReactorCoreItem(Properties properties)
	{
		super(properties);
	}
	...
	{
		tooltipComponents.add(new TranslatableComponent("tooltip.sgjourney.naquadah_generator_core.reaction_progress").append(new TextComponent(": " + reactionProgress(stack) + " / " + getMaxReactionProgress())).withStyle(ChatFormatting.GREEN));
		tooltipComponents.add(new TranslatableComponent("tooltip.sgjourney.naquadah_generator_core.description").withStyle(ChatFormatting.GRAY).withStyle(ChatFormatting.ITALIC));
