...
public interface SGJourneyWeatheringBlock extends ChangeOverTimeBlock<SGJourneyWeatheringBlock.WeatherState>
{
	...
	Supplier<BiMap<Block, Block>> NEXT_BY_BLOCK = Suppliers.memoize(() -> {
		return ImmutableBiMap.<Block, Block>builder()
				...
				.put(BlockInit.POLISHED_NAQUADAH_COPPER_STAIRS.get(), BlockInit.EXPOSED_POLISHED_NAQUADAH_COPPER_STAIRS.get())
				.put(BlockInit.EXPOSED_POLISHED_NAQUADAH_COPPER_STAIRS.get(), BlockInit.WEATHERED_POLISHED_NAQUADAH_COPPER_STAIRS.get())
				.put(BlockInit.WEATHERED_POLISHED_NAQUADAH_COPPER_STAIRS.get(), BlockInit.OXIDIZED_POLISHED_NAQUADAH_COPPER_STAIRS.get())
				...
				.put(BlockInit.CHISELED_NAQUADAH_COPPER_BLOCK.get(), BlockInit.EXPOSED_CHISELED_NAQUADAH_COPPER_BLOCK.get())
				.put(BlockInit.EXPOSED_CHISELED_NAQUADAH_COPPER_BLOCK.get(), BlockInit.WEATHERED_CHISELED_NAQUADAH_COPPER_BLOCK.get())
				.put(BlockInit.WEATHERED_CHISELED_NAQUADAH_COPPER_BLOCK.get(), BlockInit.OXIDIZED_CHISELED_NAQUADAH_COPPER_BLOCK.get())
	...
	Supplier<BiMap<Block, Block>> WAXABLES = Suppliers.memoize(() ->
	{
		return ImmutableBiMap.<Block, Block>builder()
				...
				.put(BlockInit.POLISHED_NAQUADAH_COPPER_STAIRS.get(), BlockInit.WAXED_POLISHED_NAQUADAH_COPPER_STAIRS.get())
				.put(BlockInit.EXPOSED_POLISHED_NAQUADAH_COPPER_STAIRS.get(), BlockInit.WAXED_EXPOSED_POLISHED_NAQUADAH_COPPER_STAIRS.get())
				.put(BlockInit.WEATHERED_POLISHED_NAQUADAH_COPPER_STAIRS.get(), BlockInit.WAXED_WEATHERED_POLISHED_NAQUADAH_COPPER_STAIRS.get())
				.put(BlockInit.OXIDIZED_POLISHED_NAQUADAH_COPPER_STAIRS.get(), BlockInit.WAXED_OXIDIZED_POLISHED_NAQUADAH_COPPER_STAIRS.get())
				...
				.put(BlockInit.CHISELED_NAQUADAH_COPPER_BLOCK.get(), BlockInit.WAXED_CHISELED_NAQUADAH_COPPER_BLOCK.get())
				.put(BlockInit.EXPOSED_CHISELED_NAQUADAH_COPPER_BLOCK.get(), BlockInit.WAXED_EXPOSED_CHISELED_NAQUADAH_COPPER_BLOCK.get())
				.put(BlockInit.WEATHERED_CHISELED_NAQUADAH_COPPER_BLOCK.get(), BlockInit.WAXED_WEATHERED_CHISELED_NAQUADAH_COPPER_BLOCK.get())
				.put(BlockInit.OXIDIZED_CHISELED_NAQUADAH_COPPER_BLOCK.get(), BlockInit.WAXED_OXIDIZED_CHISELED_NAQUADAH_COPPER_BLOCK.get())
