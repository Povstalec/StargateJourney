...
{
	public static boolean onStargateDial(MinecraftServer server, StargateInfo stargate, Address.Immutable dialedAddress, Address.Immutable dialingAddress, boolean doKawoosh)
    {
        return MinecraftForge.EVENT_BUS.post(new StargateEvent.Dial(server, stargate, dialedAddress, dialingAddress, doKawoosh));
    }
	
	public static boolean onStargateConnect(MinecraftServer server, StargateInfo stargate, StargateInfo connectedStargate, StargateConnection.Type connectionType, Address.Type addressType, boolean doKawoosh)
    {
	...
	public static boolean onWormholeTravel(MinecraftServer server, StargateInfo stargate, StargateInfo connectedStargate, StargateConnection.Type connectionType,
