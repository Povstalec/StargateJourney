...
public class CrystalInterfaceMenu extends AbstractContainerMenu
{
    private final CrystalInterfaceEntity blockEntity;
    ...
    public CrystalInterfaceMenu(int containerId, Inventory inv, BlockEntity entity)
    {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler ->
        {
            ...
            this.addSlot(new SlotItemHandler(handler, 2, 89, 17));
            this.addSlot(new SlotItemHandler(handler, 3, 107, 17));
            this.addSlot(new SlotItemHandler(handler, 4, 53, 35));
            this.addSlot(new SlotItemHandler(handler, 5, 71, 35));
            this.addSlot(new SlotItemHandler(handler, 6, 89, 35));
            this.addSlot(new SlotItemHandler(handler, 7, 107, 35));
        });
    }
	...
	public boolean stillValid(Player player) {
		return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
				player, BlockInit.CRYSTAL_INTERFACE.get());
	}
