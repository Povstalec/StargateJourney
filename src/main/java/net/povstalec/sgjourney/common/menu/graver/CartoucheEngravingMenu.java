...
public abstract class CartoucheEngravingMenu<C extends CartoucheBlockEntity> extends InventoryMenu<C>
{
	public final SimpleTempContainer<CartoucheEngravingMenu<C>> tempContainer = new SimpleTempContainer<>(this, 1, 1)
	{
		@Override
    ...
    public CartoucheEngravingMenu(MenuType<?> type, int containerId, Inventory inventory, C blockEntity, ContainerLevelAccess access)
    {
	...
	public static class Stone extends CartoucheEngravingMenu<CartoucheBlockEntity.Stone>
	{
		...
		{
			super(MenuInit.ENGRAVING_STONE_CARTOUCHE.get(), containerId, inventory, blockEntity, containerLevelAccess);
		}
	...
	public static class Sandstone extends CartoucheEngravingMenu<CartoucheBlockEntity.Sandstone>
    {
		...
		{
			super(MenuInit.ENGRAVING_SANDSTONE_CARTOUCHE.get(), containerId, inventory, blockEntity, containerLevelAccess);
		}
    ...
    public static class RedSandstone extends CartoucheEngravingMenu<CartoucheBlockEntity.RedSandstone>
    {
		...
		{
			super(MenuInit.ENGRAVING_RED_SANDSTONE_CARTOUCHE.get(), containerId, inventory, blockEntity, containerLevelAccess);
		}
