...
public class SchedulerInit {
	...
	public static void register()
	{
		TimerCallbacks.SERVER_CALLBACKS.register(
				new CodecSerializer<>(
						ResourceLocation.fromNamespaceAndPath(StargateJourney.MODID, "stargate_destruction"),
						StargateDestruction.class, StargateDestruction.CODEC));
		TimerCallbacks.SERVER_CALLBACKS.register(
				new CodecSerializer<>(
						ResourceLocation.fromNamespaceAndPath(StargateJourney.MODID, "shielding_destruction"),
