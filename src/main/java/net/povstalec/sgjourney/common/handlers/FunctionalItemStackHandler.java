                   ...
                   INBTSerializable<CompoundTag>
{
    ...
    /**
     * Callback for {@link #serializeNBT(HolderLookup.Provider)}.
     */
    @Nullable private SerializeNBTFunction       serializeNBTFunction;
    /**
     * Callback for {@link #deserializeNBT(HolderLookup.Provider, CompoundTag)}.
     */
    ...
    /**
     * Registers a replacement for {@link #serializeNBT(HolderLookup.Provider)}.
     */
    ...
    /**
     * Registers a replacement for {@link #serializeNBT(HolderLookup.Provider)} with override option.
     *
     * @param function user supplied lambda
     * @param override if false and a function is already set, throws an error
     * @return {@code this} for call chaining
    ...
    /**
     * Registers a replacement for {@link #deserializeNBT(HolderLookup.Provider, CompoundTag)}.
     */
    ...
    /**
     * Registers a replacement for {@link #deserializeNBT(HolderLookup.Provider, CompoundTag)} with override option.
     *
     * @param function user supplied lambda
     * @param override if false and a function is already set, throws an error
     * @return {@code this} for call chaining
    ...
    /**
     * Calls the parent implementation of {@link #serializeNBT(HolderLookup.Provider)}.
     * <p>
     * <b>Note:</b> This method is intended to be used when setting a custom function
     ...
     */
    public final CompoundTag super_serializeNBT(HolderLookup.Provider provider) { return super.serializeNBT(provider); }

    /**
     * Calls the parent implementation of {@link #deserializeNBT(HolderLookup.Provider, CompoundTag)}.
     * <p>
     * <b>Note:</b> This method is intended to be used when setting a custom function
     ...
     */
    public final void super_deserializeNBT(HolderLookup.Provider provider, @NotNull CompoundTag nbt) { super.deserializeNBT(provider,nbt); }
    ...
    public final CompoundTag serializeNBT(HolderLookup.Provider provider) {
        return (serializeNBTFunction == null) ? super.serializeNBT(provider)
                                              : serializeNBTFunction.serializeNBT(provider);
    }
    ...
    public final void deserializeNBT(HolderLookup.Provider provider, CompoundTag nbt) {
        ...
        deserializeNBTFunction.deserializeNBT(provider, nbt);
    }
