...
public class GoauldTemple extends SGJourneyStructure
{
    public static final Codec<GoauldTemple> CODEC = RecordCodecBuilder.<GoauldTemple>mapCodec(instance ->
            ...
            ).apply(instance, GoauldTemple::new)).codec();

    public GoauldTemple(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName,
