...
public class CommonTechConfig
{
	...
	public static void init(ForgeConfigSpec.Builder server)
	{
		...
		fusion_core_energy_from_fuel = server
				...
				.defineInRange("server.fusion_core_energy_from_fuel", 100_000, 1L, Long.MAX_VALUE);
		
		fusion_core_fuel_capacity = server
				.comment("The fuel capacity of a Fusion Core")
				.defineInRange("server.fusion_core_fuel_capacity", 65_536, 1, Integer.MAX_VALUE);
		...
		naquadah_power_cell_max_transfer = server
				...
				.defineInRange("server.naquadah_power_cell_max_transfer", 200_000L, 1, Long.MAX_VALUE);
		
		// Liquidizers
		
		naquadah_liquidizer_energy_capacity = server
				.comment("The maximum amount of energy the Naquadah Liquidizer can hold")
				.defineInRange("server.naquadah_liquidizer_energy_capacity", 1_000_000L, 1L, Long.MAX_VALUE);
		...
		naquadah_liquidizer_max_energy_receive = server
				...
				.defineInRange("server.naquadah_liquidizer_max_energy_receive", 100_000L, 1L, Long.MAX_VALUE);
		...
		naquadah_liquidizer_energy_per_tick = server
				...
				.defineInRange("server.naquadah_liquidizer_energy_per_tick", 1_000L, 0L, Long.MAX_VALUE);
		...
		naquadah_liquidizer_fluid_input_capacity = server
				...
				.defineInRange("server.naquadah_liquidizer_fluid_input_capacity", 4_000, 1, Integer.MAX_VALUE);
		...
		naquadah_liquidizer_fluid_output_capacity = server
				...
				.defineInRange("server.naquadah_liquidizer_fluid_output_capacity", 4_000, 1, Integer.MAX_VALUE);
		...
		naquadah_liquidizer_max_fluid_receive = server
				...
				.defineInRange("server.naquadah_liquidizer_max_fluid_receive", 1_000, 1, Integer.MAX_VALUE);
		...
		naquadah_liquidizer_max_fluid_extract = server
				...
				.defineInRange("server.naquadah_liquidizer_max_fluid_extract", 1_000, 1, Integer.MAX_VALUE);
		...
		heavy_naquadah_liquidizer_energy_capacity = server
				...
				.defineInRange("server.heavy_naquadah_liquidizer_energy_capacity", 1_000_000L, 1L, Long.MAX_VALUE);
		...
		heavy_naquadah_liquidizer_max_energy_receive = server
				...
				.defineInRange("server.heavy_naquadah_liquidizer_max_energy_receive", 100_000L, 1L, Long.MAX_VALUE);
		...
		heavy_naquadah_liquidizer_energy_per_tick = server
				...
				.defineInRange("server.heavy_naquadah_liquidizer_energy_per_tick", 1_000L, 0L, Long.MAX_VALUE);
		...
		heavy_naquadah_liquidizer_fluid_input_capacity = server
				...
				.defineInRange("server.heavy_naquadah_liquidizer_fluid_input_capacity", 4_000, 1, Integer.MAX_VALUE);
		...
		heavy_naquadah_liquidizer_fluid_output_capacity = server
				...
				.defineInRange("server.heavy_naquadah_liquidizer_fluid_output_capacity", 4_000, 1, Integer.MAX_VALUE);
		...
		heavy_naquadah_liquidizer_max_fluid_receive = server
				...
				.defineInRange("server.heavy_naquadah_liquidizer_max_fluid_receive", 1_000, 1, Integer.MAX_VALUE);
		...
		advanced_crystallizer_max_energy_receive = server
				...
				.defineInRange("server.advanced_crystallizer_max_energy_receive", 100_000L, 1L, Long.MAX_VALUE);
		...
		advanced_crystallizer_energy_per_tick = server
				...
				.defineInRange("server.advanced_crystallizer_energy_per_tick", 1_000L, 0L, Long.MAX_VALUE);
		...
		advanced_crystallizer_fluid_input_capacity = server
				...
				.defineInRange("server.advanced_crystallizer_fluid_input_capacity", 4_000, 1, Integer.MAX_VALUE);
