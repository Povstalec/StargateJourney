...
{
	public static ForgeConfigSpec.LongValue goauld_ring_panel_energy_capacity;
	public static ForgeConfigSpec.LongValue goauld_ring_panel_max_energy_receive;
	public static ForgeConfigSpec.LongValue goauld_ring_panel_max_energy_extract;
	public static ForgeConfigSpec.LongValue goauld_ring_panel_button_press_energy_cost;
	...
	public static void init(ForgeConfigSpec.Builder server)
	{
		goauld_ring_panel_energy_capacity = server
				...
				.defineInRange("server.goauld_ring_panel_energy_capacity", 200_000, 0L, Long.MAX_VALUE);
		...
		goauld_ring_panel_max_energy_receive = server
				...
				.defineInRange("server.goauld_ring_panel_max_energy_receive", 100_000, 0L, Long.MAX_VALUE);
		...
		goauld_ring_panel_max_energy_extract = server
				...
				.defineInRange("server.goauld_ring_panel_max_energy_extract", 50_000L, 0L, Long.MAX_VALUE);
		
		goauld_ring_panel_button_press_energy_cost = server
				.comment("Energy depleted by pressing a button on the Ring Panel")
				.defineInRange("server.goauld_ring_panel_button_press_energy_cost", 5_000L, 0L, Long.MAX_VALUE);
		
		
		
		ancient_transport_rings_energy_capacity = server
				.comment("Energy capacity of the Ancient Transport Rings")
				.defineInRange("server.ancient_transport_rings_energy_capacity", 1_000_000, 0L, Long.MAX_VALUE);
		...
		ancient_transport_rings_max_energy_receive = server
				...
				.defineInRange("server.ancient_transport_rings_max_energy_receive", 1_000_000, 0L, Long.MAX_VALUE);
		
		
		
		goauld_transport_rings_energy_capacity = server
				.comment("Energy capacity of the Goa'uld Transport Rings")
				.defineInRange("server.goauld_transport_rings_energy_capacity", 1_000_000, 0L, Long.MAX_VALUE);
		...
		goauld_transport_rings_max_energy_receive = server
				...
				.defineInRange("server.goauld_transport_rings_max_energy_receive", 1_000_000, 0L, Long.MAX_VALUE);
		...
		transporter_transport_energy_cost = server
				...
				.defineInRange("server.transporter_transport_energy_cost", 5_000L, 0L, Long.MAX_VALUE);
		...
		transporter_transport_distance_energy_cost = server
				...
				.defineInRange("server.transporter_transport_distance_energy_cost", 400L, 0L, Long.MAX_VALUE);
		...
		transporter_dimension_transport_energy_cost = server
				...
				.defineInRange("server.transporter_dimension_transport_energy_cost", 50_000L, 0L, Long.MAX_VALUE);
	}
}
