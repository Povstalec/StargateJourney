...
public class CommonNaquadahGeneratorConfig
{
	...
	public static ModConfigSpec.LongValue naquadah_reactor_reaction_time;
	public static ModConfigSpec.LongValue naquadah_reactor_energy_per_tick;
	public static ModConfigSpec.LongValue naquadah_reactor_capacity;
	public static ModConfigSpec.LongValue naquadah_reactor_max_transfer;
