...
public class CommonInterfaceConfig
{
	...
	public static void init(ModConfigSpec.Builder server)
	{
		default_energy_target = server
				...
				.defineInRange("server.default_energy_target", 200_000L, 1L, Long.MAX_VALUE);
		
		
		
		basic_interface_capacity = server
				.comment("The amount of energy a Basic Interface can hold")
				.defineInRange("server.basic_interface_capacity", 500_000L, 1L, Long.MAX_VALUE);
		...
		basic_interface_max_transfer = server
				...
				.defineInRange("server.basic_interface_max_transfer", 50_000L, 1L, Long.MAX_VALUE);
		
		
		
		crystal_interface_capacity = server
				.comment("The amount of energy a Crystal Interface can hold")
				.defineInRange("server.crystal_interface_capacity", 100_000_000L, 1L, Long.MAX_VALUE);
		...
		crystal_interface_max_transfer = server
				...
				.defineInRange("server.crystal_interface_max_transfer", 10_000_000L, 1L, Long.MAX_VALUE);
		
		
		
		advanced_crystal_interface_capacity = server
				.comment("The amount of energy an Advanced Crystal Interface can hold")
				.defineInRange("server.advanced_crystal_interface_capacity", 100_000_000_000L, 1L, Long.MAX_VALUE);
		...
		advanced_crystal_interface_max_transfer = server
				...
				.defineInRange("server.advanced_crystal_interface_max_transfer", 100_000_000_000L, 1L, Long.MAX_VALUE);
	}
}
