...
import woldericz_junior.stargatejourney.blocks.BatteryBlock;
...
public class StargateJourneyRegistries 
{
	...
	public static void registerItems(final RegistryEvent.Register<Item> event)
	{
		...
		(
				...
				StargateItems.naquadah_battery = new BlockItem(StargateBlocks.naquadah_battery, new Item.Properties().maxStackSize(1).group(STARGATE)).setRegistryName(StargateBlocks.naquadah_battery.getRegistryName()),
				...
				StargateItems.jaffa_staff_weapon = new Item(new Item.Properties().maxStackSize(1).group(STARGATE)).setRegistryName(location("jaffa_staff_weapon")),
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event)
	{
		...
		(
				...
				StargateBlocks.naquadah_battery = new BatteryBlock(Block.Properties.create(Material.IRON).hardnessAndResistance(3.0f, 3.0f).harvestLevel(2).harvestTool(ToolType.PICKAXE).sound(SoundType.METAL)).setRegistryName(location("naquadah_battery")),
