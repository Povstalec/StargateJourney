...
public class CustomChunkGenerator extends NoiseChunkGenerator<CustomGenSettings> {
	...
	public CustomChunkGenerator(IWorld worldIn, BiomeProvider provider, CustomGenSettings settingsIn) {
